...
async def main():
    ...
    # Автоматическое добавление пользователей при запуске
    # Формат: id, имя
    default_users = [
        (1106966008, "Богдан"),
        (6215354222, "другий аккаунт"),
        (821133315, "Паша"),
        (1165967115, "Данька")
    ]
    ...
    for uid, name in default_users:
        if not db.is_allowed(uid):
            ...
            logging.info(f"Додано користувача: {name}")

    # Автоматическое создание пар
    # Богдан <-> Другой аккаунт
    db.add_pair(1106966008, 6215354222)
    # Богдан <-> Паша
    db.add_pair(1106966008, 821133315)
    # Богдан <-> Данька
    db.add_pair(1106966008, 1165967115)

    logging.info("Базові користувачі та пари перевірені/додані.")
